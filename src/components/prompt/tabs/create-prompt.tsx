    ...
    <SafeAreaView className="flex-1 bg-white" edges={["top"]}>
      ...
      >
        ...
        <Controller
          ...
          render={({ field: { onChange, onBlur, value } }) => (
            <View
              className={`border ${errors.prompt ? "border-red-500" : "border-gray-200"} rounded-2xl min-h-[200px] p-4 mb-2`}
            >
              <TextInput
        ...
        {/* Categories */}
        <Text className="mb-3 text-sm font-semibold text-gray-500 uppercase">
          Categories
        </Text>
